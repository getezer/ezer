...
1. Insight Engine — joins Tier 1 + Tier 2, produces insight objects
2. Schedule Integrity Checker — reads flags, generates correction requests
3. PED Quality Checker — scores contestation risk on declared PEDs
4. FastAPI endpoint — wraps the engine
5. Correspondence Tracker — tracks open items, Ombudsman-aware
6. Claim navigation features — only after the above are solid
